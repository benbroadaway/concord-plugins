...
class JiraClientTest {
    ...
    void testPostFile() throws IOException {
        ...
        assertEquals("multipart/form-data; boundary=" + JiraClient.BOUNDARY, contentType);
    ...
    void testResponseCodes() {
        var ex400 = assertThrows(IllegalStateException.class, () -> JiraClient.assertResponseCode(400, "example message", 200));
        assertTrue(ex400.getMessage().contains("input is invalid"));
        var ex401 = assertThrows(IllegalStateException.class, () -> JiraClient.assertResponseCode(401, "example message", 200));
        assertTrue(ex401.getMessage().contains("User is not authenticated"));
        var ex403 = assertThrows(IllegalStateException.class, () -> JiraClient.assertResponseCode(403, "example message", 200));
        assertTrue(ex403.getMessage().contains("User does not have permission to perform request"));
        var ex404 = assertThrows(IllegalStateException.class, () -> JiraClient.assertResponseCode(404, "example message", 200));
        assertTrue(ex404.getMessage().contains("Issue does not exist"));
        var ex500 = assertThrows(IllegalStateException.class, () -> JiraClient.assertResponseCode(500, "example message", 200));
        assertTrue(ex500.getMessage().contains("Internal Server Error"));
        var exUnknown = assertThrows(IllegalStateException.class, () -> JiraClient.assertResponseCode(501, "example message", 200));
